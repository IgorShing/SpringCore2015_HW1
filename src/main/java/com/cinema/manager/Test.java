...
public class Test {
	...
	public static void main(String[] args) {
		...
		/*
		 * usersList.add(new User("1", "Peter", "peter@gmail.com", new DateTime(
		 * 1995, 3, 6, 12, 0, 0, 0))); usersList.add(new User("2", "Anna",
		 * "anna@gmail.com", new DateTime( 1985, 5, 21, 12, 0, 0, 0)));
		 * usersList.add(new User("3", "Leo", "leo@gmail.com", new
		 * DateTime(1983, 2, 23, 12, 0, 0, 0))); usersList.add(new User("4",
		 * "Maria", "maria@gmail.com", new DateTime( 1987, 1, 2, 12, 0, 0, 0)));
		 */
